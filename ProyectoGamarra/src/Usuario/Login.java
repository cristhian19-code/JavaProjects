...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/Seguridad.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
        String sql="select * from cuentas where usuario='"+txtusuario.getText()+"' and password='"+txtpassword.getText()+"'";
            clase ov = new clase();
            ov.Base="usuarios";
            ov.conectar();
            ResultSet rs = ov.verDatos(sql);
            if(rs.next()){
                dispose();
                FrmGamarra gam = new FrmGamarra();
                gam.setExtendedState(MAXIMIZED_BOTH);
                gam.setVisible(true);
            }else{
               Registrar regis = new Registrar();
               int res=JOptionPane.showConfirmDialog(null, "Desea crearse una cuentas","Usuario no registrado",JOptionPane.YES_NO_OPTION);
               if(res==0){
                   regis.setExtendedState(HEIGHT);
